...
public class GridTest1 {
	 ...
	 * and type the following command
	 * 
	 * Option1-(sometime not working for 3.0, it will work for 2.0)
	 * java -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.1.21:4444/grid/register/
	 * 
	 * Option2- (selenium 3.0)
	 * Node URL (chrome)
	 ...
	 * Node URL (ff+chrome)
	 * java -Dwebdriver.chrome.driver="C:\Users\admin\Downloads\chromedriver_win32\chromedriver.exe" -Dwebdriver.gecko.driver="D:\Training\TrainingContent\SeleniumJars_Software\geckodriver_64\geckodriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.1.21:4444/grid/register/ -browser "browserName=firefox,version=ANY,platform=WINDOWS,maxInstances=5" -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
	 * 
